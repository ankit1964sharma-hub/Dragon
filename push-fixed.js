...
async function getAllFiles(dir, baseDir = dir) {
  ...
  const ignoreFiles = ['.replit', '.env', 'replit.nix', 'push-fixed.js', 'push-minimal.js', 'cleanup.js'];
...
async function push() {
  ...
  const { data: commit } = await octokit.git.createCommit({
    owner: 'ankit1964sharma-hub', repo: 'Dragon',
    message: 'Fix: Update to 100% pure Node.js - remove tsx dependency\n\n✅ WORKING CLEAN VERSION:\n- Pure Node.js scripts (no tsx/TypeScript at runtime)\n- All APIs tested and working\n- Discord bot fully functional\n- Minimal codebase with only necessary features\n- 27 essential dependencies\n- Ready for any Node.js hosting',
  ...
  console.log('\n✅ Pushed working version to GitHub!');
