...
async function getAllFiles(dir, baseDir = dir) {
  ...
  const ignoreFiles = ['.replit', '.env', 'replit.nix', 'final-clean-push.js'];
...
async function push() {
  ...
  console.log('\n🎉 GitHub will now show 100% JavaScript!\n');
}
